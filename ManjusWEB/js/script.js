  document.addEventListener('DOMContentLoaded', () => {
            ...
            const roles = [
                ...
                "Startup Visionary",
                "Developer & Founder - Oursaloon", 
                "Developer & Founder – Data Wallet System",
                "Founder & Developer – AI CCTV Proctoring System",
            ...
            if (tiltCard) {
                ...
                function handleTilt(e) {
                    ...
                    const x = (e.clientX - rect.left) - width / 2.5;
                    const y = (e.clientY - rect.top) - height / 2.5;
                    const tiltX = (y / (height / 3)) * MAX_TILT; 
                    const tiltY = -(x / (width / 3)) * MAX_TILT; 
